...
<!--
**Ipraveenkumar-star/Ipraveenkumar-star** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
class PraveenKumar {
  ...
  String get motto => "CGPA measures memory. GitHub measures impact.";
}
```
...
- 📱 **[Project Name]** — A Flutter app that [what it does]. [Add repo link]
- 🔧 **Learning** — Flutter state management (Riverpod/BLoC) & REST API integration
- 🎯 **Goal this month** — Publish my first app to the Play Store

> _"I don't wait to understand everything before I build. I build to understand."_
...
> CGPA reflects how well you studied for exams.  
> GitHub reflects how well you solve real problems.  
> I believe in the second one.

I pick up new technologies fast — not because I memorize docs, but because I dive in and build. Give me a new framework and a week, and I'll have something working.
